...
//all defined in 3.4/source/blender/makesdna/DNA_meshdata_types.h
...
SimpleMesh convert_to_simple_mesh(mirr::MVert* vertices, int num_verts, mirr::MEdge* edges, int num_edges, mirr::MPoly* polygons, int num_polys, mirr::MLoop* loops, int num_loops) {
